...
class Formulaire(models.Model):
    ...
    chapitre = models.ForeignKey(Chapter, on_delete=models.CASCADE, related_name='formulaires')  # Lien vers le chapitre
    ...
    utilisateur = models.ForeignKey(User, on_delete=models.CASCADE, related_name='formulaires', null=True, blank=True)  # Rendre facultatif
...
class Rapport(models.Model):
    course = models.ForeignKey(Course, on_delete=models.CASCADE, related_name="rapports")  # Lien vers le cours
    formulaire = models.ForeignKey(Formulaire, on_delete=models.CASCADE, related_name="rapports", null=True, blank=True)  # Lien vers un formulaire (facultatif)
